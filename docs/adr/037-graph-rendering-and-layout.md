...
names the app uses: the panel is labelled "Connections" and the section in it
that holds the drawing reads "Nearby notes", the whole-folder view's heading
reads "Graph", and the palette opens it as "Open graph".
