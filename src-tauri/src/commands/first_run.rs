...
/// IPC: records the format and the apps the first-launch screens were
/// answered with and opens the file that launch shows.
///
...
pub fn finish_first_run(
    ...
    let opened = crate::first_run::finish_first_run_inner(&state, default_extension, &apps)?;
