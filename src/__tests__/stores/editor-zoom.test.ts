...
const MOCK_CONFIG: WritConfig = {
  ...
  editor: { font_family: "JetBrains Mono", font_size: 16, word_wrap: true, tab_size: 4, autosave_debounce_ms: 500, markdown_typography: true, markdown_editing: true, status_bar: false, status_bar_counts: false },
