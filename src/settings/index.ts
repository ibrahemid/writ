...
export const SETTINGS_INDEX: SettingEntry[] = [
  ...
  { id: "ai.chat_enabled", section: "ai", title: "Chat about the notes you attach", keywords: ["ai", "chat", "ask", "conversation", "model", "attach", "enable"] },
  { id: "ai.chat_provider", section: "ai", title: "Chat provider", keywords: ["ai", "chat", "provider", "anthropic", "ollama", "openai", "compatible"] },
  { id: "ai.chat_base_url", section: "ai", title: "Chat base URL", keywords: ["ai", "chat", "base url", "endpoint", "host", "server"] },
  { id: "ai.chat_model", section: "ai", title: "Chat model", keywords: ["ai", "chat", "model", "id"] },
  { id: "ai.chat_api_key", section: "ai", title: "Chat API key", keywords: ["ai", "chat", "api key", "token", "secret", "credential"] },
