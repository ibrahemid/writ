...
export const SETTINGS_INDEX: SettingEntry[] = [
  ...
  { id: "appearance.polarity", section: "appearance", title: "Appearance", keywords: ["light", "dark", "system", "theme", "polarity", "follow system"] },
  { id: "appearance.accent", section: "appearance", title: "Accent colour", keywords: ["accent", "colour", "color", "pine", "highlight"] },
