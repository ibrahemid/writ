...
// Singleton state — Writ is single-window. The Rust UpdatePhase is the source
// of truth; this store mirrors it from writ://update-status events and exposes
// the user actions that drive transitions.
